...
$mainMenu = [
  ...
  "nos_voitures.php" =>["menu_title" => "nos vehicules", "head_title" => "acceuil menu", "meta_description" => "tous nos véhicule d'occasion"],
...
<html lang="en">
  <head>
    ...
    <meta name="déscription" content="<?=$mainMenu[$currentPage]["meta_description"] ?>"/>
  ...
  <header>
    ...
    <div class="imageCar">
      <h1>REVISION</h1>
      <p>Savez-vous de quand date la dernière révision de votre véhicule ? Connaissez-vous bien tous les risques d’une auto présentant un défaut d’entretien ? C’est le moment de réviser !</p>
    </div>
  </header>
